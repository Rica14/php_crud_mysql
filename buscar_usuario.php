                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="crud20.php">OPG's Tlaxcala</a></li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="crud24.php">COP Tlaxcala</a></li>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Subestación: ANC - Santa Ana Chiautempan</h4>
...
<?php if (isset($_SESSION['message'])) { ?>
  <div class="alert  alert-<?= $_SESSION['message_type']?> alert-dismissible fade show" role="alert">
    ...
    $query = "SELECT Circuito, Direccion_del_Tramo, Tipo_Equipo TEXT() as Seleccionamiento_Inicial_anc
                FROM subestacion_anc_santa_ana_chiauhtempan_todos_los_circuitos
                WHERE status = '1'
                AND (contenido LIKE '%" . $keywords . "%'
                OR titulo LIKE '%" . $keywords . "%')
                ORDER BY fecha desc";

    $query_searched = mysqli_query($query, $conn);
    ...
    if ($count_results > 0) {
        ...
        while ($row_searched = mysqli_fetch_array($query_searched)) {
            ...
            echo '<li><a href="#">'.$row_searched['Circuito'].' ('.$row_searched['Seleccionamiento_Inicial_anc'].') 
                                 ('.$row_searcherd['Direccion_del_Tramo'].') ('.$row_searched['Usuarios'].') 
                                 ('.$row_searched['Fases'].') ('.$row_searched['Tipo_Equipo'].') </a></li>';
        }
        echo '</ul>';
    }
    else {
...
?>
    ...
    <input type="submit" name="search" id="search" value="Buscar">
      ...
      <thead>
        ...
        <?php
          $query = "SELECT * FROM  subestacion_anc_santa_ana_chiauhtempan_todos_los_circuitos";
          $row = mysqli_query($conn, $query); { ?>
            <?php foreach($row as $valor): ?>
                <tr>
            <td><?php echo $valor['Circuito'];?></td>
              <td><?php echo $valor['Seleccionamiento_Inicial_anc']; ?></td>
              <td><?php echo $valor['Direccion_del_Tramo']; ?></td>
              <td><?php echo $valor['Usuarios']; ?></td>
              <td><?php echo $valor['Demanda_kW']; ?></td>
              <td><?php echo $valor['Fases']; ?></td>
              <td><?php echo $valor['Tipo_Equipo']; ?></td>
              <td>
                <a href="edit.php?Seleccionamiento_Inicial_anc=<?php echo $valor['Seleccionamiento_Inicial_anc']?>" class="btn btn-secondary">
                  <i class="fas fa-marker"></i>
                </a>
                <a href="delete_task.php?Seleccionamiento_Inicial_anc=<?php echo $valor['Seleccionamiento_Inicial_anc']?>" class="btn btn-danger">
