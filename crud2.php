            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Subestación: ATZ - Atlihuetzia - 5240 - 5250 - 5260</h4>
  ...
  <div class="alert  alert-<?= $_SESSION['message_type']?> alert-dismissible fade show" role="alert">
    ...
    <div class="col-md-8">
      <table class="table table-bordered">
        ...
        <?php
          $query = "SELECT * FROM  subestacion_atz_atlihuetzia_circuitos_5240_5250_5260";
          $row = mysqli_query($conn, $query); { ?>
            <?php foreach($row as $valor): ?>
                <tr>
            <td><?php echo $valor['Circuito'];?></td>
              <td><?php echo $valor['Seleccionamiento Inicial atz 3']; ?></td>
              ...
              <td>
                <a href="edit.php?Seleccionamiento Inicial atz 3=<?php echo $valor['Seleccionamiento Inicial atz 3']?>" class="btn btn-secondary">
                  <i class="fas fa-marker"></i>
                </a>
                <a href="delete_task.php?Seleccionamiento Inicial atz 3=<?php echo $valor['Seleccionamiento Inicial atz 3']?>" class="btn btn-danger">
