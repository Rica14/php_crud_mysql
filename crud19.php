            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">Subestación: XLT - Xalostoc</h4>
  ...
  <div class="alert  alert-<?= $_SESSION['message_type']?> alert-dismissible fade show" role="alert">
    ...
    <div class="col-md-8">
      <table class="table table-bordered">
        ...
        <?php
          $query = "SELECT * FROM  subestacion_xlt_xalostoc_todos_los_circuitos";
          $row = mysqli_query($conn, $query); { ?>
            <?php foreach($row as $valor): ?>
                <tr>
            <td><?php echo $valor['Circuito'];?></td>
              <td><?php echo $valor['Seleccionamiento Inicial xlt']; ?></td>
              ...
              <td>
                <a href="edit.php?Seleccionamiento Inicial xlt=<?php echo $valor['Seleccionamiento Inicial xlt']?>" class="btn btn-secondary">
                  <i class="fas fa-marker"></i>
                </a>
                <a href="delete_task.php?Seleccionamiento Inicial xlt=<?php echo $valor['Seleccionamiento Inicial xlt']?>" class="btn btn-danger">
