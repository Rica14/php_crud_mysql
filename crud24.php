            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title">COP TLAXCALA</h4>
  ...
  <div class="alert  alert-<?= $_SESSION['message_type']?> alert-dismissible fade show" role="alert">
    ...
    <div class="col-md-8">
      <table class="table table-bordered">
        ...
        <?php
          $query = "SELECT * FROM  subestacion_anc_santa_ana_chiauhtempan_todos_los_circuitos WHERE left (Seleccionamiento_Inicial_anc, 1)='C'";
